// ChartBorderRadius.js
export default function (Highcharts) {
  if (Highcharts._borderRadiusApplied) return

  // Markiere das Highcharts-Objekt, um zu signalisieren, dass das Modul angewendet wurde
  Highcharts._borderRadiusApplied = true
  ;(function (H) {
